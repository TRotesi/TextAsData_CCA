...
| **Evaluation** | None — three optional, ungraded problem sets |
...
**Materials:** [Slides (PDF)](slides/Class5/Class5_Slides_Torino.pdf)
...
Three applied, ungraded exercises — one for each of the first three sessions. They
...
| [`problem_sets/`](problem_sets/) | Links to the three problem sets. |
